...
function SectionContent({
  ...
  switch (section) {
    case "Home":
      ...
      return (
        <div
          className="w-100 d-flex flex-column align-items-center mt-2 position-relative py-4"
          style={{
            background: "#fff",
            borderRadius: 12,
        ...
        >
          ...
          <div className="z-1 mt-2 mb-2 d-flex flex-column flex-md-row align-items-center justify-content-center gap-2 w-100">
            ...
            />
            <img
              alt="The Second National Conference on New Educational Technologies and Informatics (NCNETI'25)"
              className="mt-0"
              src="/logoHuge.png"
              style={{
                height: 90,
          ...
          >
            <i
              ...
              style={{ fontSize: 16, color: "#3f5efb" }}
            ></i>{" "}
            October 1-2, 2025 at the&nbsp;
            <a
            ...
            >
              LabSTIC Laboratory, University of Guelma, Algeria.
            </a>
          </p>
          <p
            className="col-11 text-center"
            style={{ fontFamily: "Open Sans, sans-serif", color: "#23272f" }}
          >
            The LabSTIC Laboratory is pleased to announce the second edition of
            NCNETI'25, taking place on October 1-2, 2025. <br /> <br />
            This national conference provides a platform for researchers,
            academics, and doctoral students to present their latest research
            and advancements in new educational technologies and informatics.{" "}
            <br /> Participants will have the opportunity to share theoretical
            insights, innovative methodologies, and practical applications,
            fostering collaboration and knowledge exchange within the academic
            community.
          </p>
          <div className="d-flex flex-column align-items-center mt-3 gap-1 z-1">
            ...
            <a
              href="/assets/pdf/CallForPaper_NCNETI25.pdf"
              target="_blank"
              rel="noopener noreferrer"
    ...
    case "Topics":
      ...
      const topicsCol1 = [
        {
          ...
          icon: (
            <i
              ...
              style={{ color: "#40cfff", marginRight: 8 }}
            ></i>
          ),
        },
        {
          text: "Machine Learning & Big Data in Education",
          icon: (
            <i
        ...
        {
          text: "Internet of Things (IoT) and Its Use in Education",
          icon: (
            <i
        ...
        },
        {
          ...
          icon: (
            <i
              ...
              style={{ color: "#e91e63", marginRight: 8 }}
            ></i>
          ),
        },
        {
          text: "Artificial Intelligence & Its Application",
          icon: (
            <i
        ...
        {
          text: "Computer Vision & Pattern",
          icon: (
            <i
              className="fa-solid fa-eye"
              style={{ color: "#3f51b5", marginRight: 8 }}
            ></i>
          ),
        },
        {
          ...
          icon: (
            <i
              ...
              style={{ color: "#00bcd4", marginRight: 8 }}
            ></i>
          ),
        },
        {
          text: "E-learning, Mobile Learning and Intelligent Tutoring Systems",
          icon: (
            <i
              className="fa-solid fa-tablet-screen-button"
              style={{ color: "#8bc34a", marginRight: 8 }}
            ></i>
          ),
        },
        {
          text: "E-Government and E-business",
          icon: (
            <i
              className="fa-solid fa-building"
              style={{ color: "#ff5722", marginRight: 8 }}
            ></i>
          ),
        },
        {
          text: "Intelligent and Decision Support Systems",
          icon: (
            <i
      ...
      const topicsCol2 = [
        ...
        {
          text: "Software Systems, Architectures, Applications and Tools",
          icon: (
            <i
              className="fa-solid fa-diagram-project"
              style={{ color: "#009688", marginRight: 8 }}
            ></i>
          ),
        },
        {
        ...
        },
        {
          ...
          icon: (
            <i
              ...
              style={{ color: "#673ab7", marginRight: 8 }}
            ></i>
          ),
        },
        {
          text: "Social and Green Computing",
          icon: (
            <i
        ...
        {
          text: "AI for Remote Monitoring and Telemedicine",
          icon: (
            <i
        ...
        },
        {
          ...
          icon: (
            <i
              ...
              style={{ color: "#795548", marginRight: 8 }}
            ></i>
          ),
        },
        {
          text: "IT for Agriculture, Tourism and Natural Resource Management",
          icon: (
            <i
        ...
        {
          text: "كما نرحب بكل المشاركات باللغة العربية والخاصة بتطبيقات الاعلام الالي في ميادين اللسانيات، اللغات، المحاسبة ، الاعلام والاتصال وغيرها...",
          icon: (
            <i
              className="fa-solid fa-language"
              style={{ color: "#607d8b", marginRight: 8 }}
      ...
      return (
        <div>
          <h4 className="d-flex align-items-center gap-2 mb-3">
            <i
              className="fa-solid fa-book-open"
              style={{ fontSize: 22, color: "#40cfff" }}
            ></i>
            Topics of Interest
          </h4>
      ...
      return (
        <div
          style={{
            background: "#fff",
            borderRadius: 16,
            boxShadow: "0 2px 16px rgba(0,0,0,0.133)",
        ...
        >
          ...
          >
            <i
              ...
              style={{ fontSize: 22, color: "#3246d3" }}
            ></i>
            Important Dates
          </h4>
          <ul
          ...
          >
            ...
            >
              ...
              <span>
                ...
                <span
                  style={{ fontWeight: 700, fontSize: 15, color: "#fc466b" }}
                >
                  August 25, 2025
                </span>
              </span>
            ...
            >
              ...
              <span style={{ fontWeight: 700, fontSize: 15, color: "#40cfff" }}>
                October 1-2, 2025
              </span>
            </li>
          </ul>
        ...
        <div>
          <h4 className="d-flex align-items-center gap-2">
            <i
              ...
              style={{ fontSize: 18, color: "#40cfff" }}
            ></i>
            Committees
          </h4>
          ...
          >
            ...
            >
              <i
                className="fa-solid fa-star"
                style={{ marginRight: 8, color: "#e67e22" }}
              ></i>
              Honorary Chairmen
            </h6>
            <ul
          ...
          <div className="d-flex flex-column flex-md-row gap-3 align-items-start flex-wrap">
            ...
            >
              ...
              >
                <h6
                  className="d-flex align-items-center"
                  style={{ color: "#40cfff", fontWeight: 700 }}
                >
                  <i
                    className="fa-solid fa-award"
                    style={{ marginRight: 8, color: "#40cfff" }}
                  ></i>
                  Organization Chair
                </h6>
                <ul
          ...
          >
            ...
            >
              ...
              <p style={{ color: "#fff", fontSize: 16, lineHeight: 1.7 }}>
                University of 8 Mai 1945 Guelma (UGUELMA) is a large (uniRank
                enrollment range: 15,000-19,999 students) coeducational Algerian
                higher education institution that offers courses and programs
                leading to officially recognized higher education degrees such
                as bachelor's degrees, master's degrees and doctorate degrees in
                several areas of study. This 37-year-old Algerian
                higher-education institution has a selective admission policy
                based on students' past academic records and grades. The
                admission rate range is 50-60% making this Algerian higher
                education organization an averagely selective institution.
                International students are welcome to apply for enrollment.
                UGUELMA also provides several academic and non-academic
                facilities and services to students including a library,
                housing, sports facilities, financial aids and/or scholarships,
          ...
          <div>
            <div className="mb-4">
              ...
              <p style={{ marginBottom: "1rem" }}>
                Participation Fees include: Admission to all technical sessions,
                refreshments during breaks and launches, conference materials,
                and social program. The conference fees do not include
                accommodation.
              </p>
              <div
              ...
              >
                ...
                >
                  ...
                  <p style={{ textAlign: "center" }}>
                    Rue N°21,Guelma,Algérie.
                    <br />
                    <strong>Phone: </strong>06666666 <br />
                    <strong>Facebook:</strong>{" "}
                    <a
                      href="https://www.facebook.com/people/H%C3%B4tel-Lalla-Maouna/100090674828987/"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "#40cfff" }}
                    >
                    ...
                    <a
                      href="https://lalla-maouna-hotel.com/"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "#40cfff" }}
                    >
                  ...
                  <p style={{ textAlign: "center" }}>
                    ...
                    <img
                      ...
                      alt="Lalla Maouna Prices"
                      height={100}
                      style={{ margin: "8px 0", filter: "invert(1)" }}
                    />
                    <br />
                    <strong>Rooms are equipped with:</strong> WiFi, Smart-TV,
                    Air conditioner, Refrigerator and Room Service.
                    <br />
                    <strong>
                      <a
                        href={barakaPdf}
                ...
                >
                  ...
                  <p style={{ textAlign: "center" }}>
                    Hammam Ouled Ali, Heliopolis, Guelma, Algérie. <br />
                    <strong>Phone:</strong> H.A: 037239205 | H.B: 037239181 |
                    H.C: 037239389 <br />
                    <strong>webSite:</strong>{" "}
                    <a
                      href="https://www.complexe-elbaraka.com"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "#40cfff" }}
                    >
                      www.complexe-elbaraka.com
                    </a>
                    <br />
                    <strong>Fax: </strong>037239174 | 037239175 <br />
                    <strong>Email: </strong>
                    <a
                      href="mailto:elbarraka24@gmail.com"
                      style={{ color: "#40cfff" }}
                    >
                      elbarraka24@gmail.com
                    </a>{" "}
                    |{" "}
                    <a
                      href="mailto:reservation@complexe-elbaraka.com"
                      style={{ color: "#40cfff" }}
                    >
                  ...
                  <p style={{ textAlign: "center" }}>
                    ...
                    <img
                      src={elBarakaPrices}
                      alt="El-Baraka Prices"
                      height={100}
                      style={{ margin: "8px 0", filter: "invert(1)" }}
                    />
                    <br />
                    <strong>Rooms are equipped with:</strong> Central heating,
                    Air conditioner, Refrigerator, TV, Thermal shower, Telephone
                    and Mineral water.
                    <br />
                    <a
                      href={elBarakaTarifPdf}
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "#40cfff" }}
                    >
    ...
    case "Sponsors":
      ...
      return (
        <div>
          ...
          >
            We gratefully acknowledge the generous support of our sponsors and
            ...
            >
              ...
              >
                <i
                  ...
                  style={{ fontSize: 54, marginBottom: 8, color: "#fff0f5" }}
                ></i>
                <span
                ...
                >
                  P.O.B 401 Guelma 24000 - Algeria
                  <br />
                  View on Google Maps
                </span>
              </a>
            ...
            <div className="d-flex flex-column flex-md-row gap-3">
              ...
              >
                <i
                  ...
                  style={{ fontSize: 54, marginBottom: 8, color: "#ea4335" }}
                ></i>
                <span
                  style={{
                    fontWeight: 700,
              ...
              >
                <i
                  ...
                  style={{ fontSize: 54, marginBottom: 8, color: "#3f5efb" }}
                ></i>
                <span
                  style={{
                    fontWeight: 700,
              ...
              >
                <i
                  ...
                  style={{ fontSize: 54, marginBottom: 8, color: "#1877f3" }}
                ></i>
                <span
                  style={{
                    fontWeight: 700,
              ...
              >
                <i
                  ...
                  style={{ fontSize: 54, marginBottom: 8, color: "#25d366" }}
                ></i>
                <span
                  style={{
                    fontWeight: 700,
          ...
          <div className="mb-3">
            <div className="p-3 rounded-3 shadow-sm bg-dark bg-opacity-75 border border-primary text-start">
              <h4 className="d-flex align-items-center gap-2 mb-3 text-start">
                <i
                  className="fa-solid fa-upload"
                  style={{ fontSize: 20, color: "#40cfff" }}
                ></i>
                Submit Paper
              </h4>
              <p className="mb-0 text-start" style={{ fontSize: 15 }}>
                All papers must be original and should not be under
                consideration for publication in any other journal or
                conference.
              </p>
              <a
                href="https://cmt3.research.microsoft.com/NCNETI2025/Submission/Index"
                target="_blank"
                rel="noopener noreferrer"
                style={{ textDecoration: "none", width: "auto" }}
              >
            ...
            <div className="p-3 rounded-3 shadow-sm bg-dark bg-opacity-75 border border-warning text-start">
              <h4 className="d-flex align-items-center gap-2 mb-3 text-start">
                <i
                  ...
                  style={{ fontSize: 20, color: "#f7971e" }}
                ></i>
                Templates
              </h4>
              <p className="mb-0 text-start" style={{ fontSize: 15 }}>
                Download and use the official templates for your submission.
                Both full and short paper templates are provided below.
              </p>
            </div>
          </div>
              ...
              <div className="p-3 h-100 rounded-3 shadow-sm bg-secondary bg-opacity-75 border border-info text-start">
                <h5 className="d-flex align-items-center gap-2 mb-2 text-start">
                  <i
                    ...
                    style={{ color: "#40cfff", fontSize: 18 }}
                  ></i>
                  Full Paper Research Submission
                </h5>
                <p className="mb-2 text-start" style={{ fontSize: 15 }}>
                  Full papers must be written in English (6–8 pages, including
                  figures, tables, and references) and prepared using the
                  official CEUR LaTeX template. <br /> Accepted papers will be
                ...
                <ul className="mb-2 text-start" style={{ fontSize: 15 }}>
                  <li>
                    <a
                      href="https://ceur-ws.org/Vol-XXX/CEURART.zip"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{
                        display: "inline-flex",
            ...
            <div className="col-md-6">
              <div className="p-3 h-100 rounded-3 shadow-sm bg-secondary bg-opacity-75 border border-success text-start">
                <h5 className="d-flex align-items-center gap-2 mb-2 text-start">
                  <i
                    className="fa-regular fa-file-lines"
                    style={{ color: "#47d147", fontSize: 18 }}
                  ></i>
    ...
    <div style={{ minHeight: "100vh", fontFamily: "Open Sans, sans-serif" }}>
      ...
      <div
        style={{
          ...
          pointerEvents: "auto",
          transition:
            "background 0.2s, height 0.2s, min-width 0.2s, max-width 0.2s, top 0.2s",
        }}
      ...
      >
        <Container
          fluid
          className="px-2 justify-content-end"
      ...
      {/* Footer */}
      <footer
        className="footer mt-auto pb-0 mb-0 py-2 bg-dark text-white fixed-bottom border-top border-secondary shadow"
        style={{ fontFamily: "Open Sans, sans-serif", zIndex: 1200 }}
      >
        <div
        ...
        >
          <div style={{ fontSize: 12, flex: "0 0 auto" }}>
            Webmaster:{" "}
            <a
              href="https://rochdiboudjehem.github.io/"
              style={{
          ...
          >
            ...
            >
              <i
                className={`fa-solid ${
                  ackOpen ? "fa-circle-chevron-down" : "fa-circle-chevron-up"
                }`}
                style={{
          ...
          <div style={{ fontSize: 12, flex: "0 0 auto" }}>
            ...
            <strong style={{ fontSize: 12 }}>
              LabSTIC {windowWidth < 768 ? "Lab." : " Laboratory"}
            </strong>
          </div>
        </div>
        <div
          className="container text-center small pt-1 pb-1"
          style={{ color: "#B7AC3F", opacity: 0.92 }}
        >
          <div
